...
export class RecruitmentService {
  ...
  async prepareDocument(rawToken:string,payload:Record<string,unknown>){
    ...
    try{
      ...
      const {presignedUrl}=await presignUrl(signed,{access:'private',pathname,operation:'put',validUntil,maximumSizeInBytes:byteSize,allowedContentTypes:[contentType],addRandomSuffix:false,allowOverwrite:false});
