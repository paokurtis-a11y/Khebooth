...
export class CommerceController {
  constructor(
    ...
    private readonly localizedSite: LocalizedSiteService,
    private readonly paymentAnalytics: PaymentAnalyticsService,
    private readonly siteContent: SiteContentService,
  ) {}

  @Get('public/site')
  publicSite(@Headers('x-vercel-ip-country') detectedCountry?:string,@Query('country') requestedCountry?:string,@Query('currency') currency?:string){return this.localizedSite.publicSite(requestedCountry||detectedCountry,currency);}
