  ...
  const runChecks=useCallback(async()=>{
    ...
    try{
      ...
      if(controlResult.status==='fulfilled'){
        ...
        setLinkState({status:control.sharingConnectionStatus,fresh});
        next.push({id:'link',title:c.link,detail:accepted&&fresh?c.linkOk:control.sharingConnectionStatus==='PENDING'?c.linkPending:c.linkOff,level:accepted&&fresh?'PASS':'WARN'});
      }else{
