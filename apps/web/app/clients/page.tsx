...
export default function ClientsPage() {
  ...
  return <PortalShell>
    <div className="header"><div><h1>Clients</h1><p>Identité, abonnement, paiement, accès Enterprise et progression commerciale dans une seule fiche.</p></div></div>
