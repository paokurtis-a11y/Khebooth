...
const GROUP_META:Record<string,{icon:string;description:string}>={
  ...
  Marketing:{icon:'02',description:'Analyses, campagnes, communications et rapports.'},
  Administration:{icon:'03',description:'Site, facturation, équipe et sécurité.'},
};
