...
- `KHE_PLATFORM_VERSION`: release number displayed by the assistant (currently `0.3.1`). Vercel's short Git SHA is appended automatically.
...
3. Set `KHE_PLATFORM_VERSION=0.3.1`, then redeploy the API and Web projects.
